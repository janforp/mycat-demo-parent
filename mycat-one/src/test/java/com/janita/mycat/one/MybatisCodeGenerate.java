...
public class MybatisCodeGenerate {
    // -custom
    private static String[] tableNames = new String[]{"user","member","shop"};
    // 程序会自动找到basePath
    private static String basePath = null;

    private static Logger log = LoggerFactory.getLogger(MybatisCodeGenerate.class);

    private static final String DAO_PACKAGE = "com.janita.mycat.one.dao" ;
    ...
    public void codegenForOneTable(String oneTableName) throws Exception {
        ...
        String modalPackage = "com.janita.mycat.one.bean";
        String daoPackage = "com.janita.mycat.one.dao";
